...
module.exports = {
 ...
 countDown: 5,
 role: 0,
 shortDescription: "Shhh meme",
 longDescription: "Generates a meme: sender's avatar on top, replied/mentioned user's avatar on bottom",
 category: "fun",
 guide: {
 ...
 try {
 const templateUrl = "https://i.ibb.co/8gVLWx3T/IMG-20260901-153124.jpg";
 ...
 drawAvatarInCircle(avatarTop, w * 0.55, h * 0.12, w * 0.16);
 drawAvatarInCircle(avatarBottom, w * 0.33, h * 0.72, w * 0.19);

 const cacheDir = path.join(__dirname, "cache");
 await fs.ensureDir(cacheDir);
 const filePath = path.join(cacheDir, `shhh_${senderID}.png`);

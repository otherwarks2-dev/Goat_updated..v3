...
module.exports = {
    ...
    langs: {
        ...
        en: {
            ...
            noMsg: "✅ | There are no members with less than %1"
        }
    },

    // GoatBot-style command execution
    onStart: async ({ api, args, threadsData, message, event, commandName, getLang }) => {
    ...
    onReaction: async ({ api, Reaction, event, threadsData, message, getLang }) => {
        ...
        // Get members with less than minimum messages
        const membersToKick = threadData.members.filter(member =>
